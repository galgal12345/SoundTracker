...
public class StudyAdapter extends BaseAdapter {
    ...
    public StudyAdapter(Context context, int layout, ArrayList<Study> studyList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StudyAdapter.ViewHolder viewHolder;
        if(convertView == null) {
            viewHolder = new StudyAdapter.ViewHolder();
            ...
            viewHolder = (StudyAdapter.ViewHolder) convertView.getTag();
        }

        Study study = studyList.get(position);

        viewHolder.txtName.setText(study.getName());
        viewHolder.txtSinger.setText(study.getSinger());
        ...
        viewHolder.ivPlay.setOnClickListener(v -> {
            if(flag){
                mediaPlayer = MediaPlayer.create(context, study.getSong());
                flag = false;
            }
